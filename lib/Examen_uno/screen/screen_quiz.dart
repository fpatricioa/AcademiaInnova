...
import '../screen/screen_results.dart';
import '../widget/widget_cadidate.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text(
              'Ejercicio ' + (_currentIndex + 1).toString() + '.',
              style: TextStyle(
                  fontSize: width * 0.06, fontWeight: FontWeight.bold, color: Colors.red),
            ),
          ),
          Container(
            width: width * 0.8,
